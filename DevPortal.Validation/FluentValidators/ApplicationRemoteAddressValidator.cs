...
{
    public class ApplicationRemoteAddressValidator : AbstractValidator<ApplicationRemoteAddress>
    {
        public ApplicationRemoteAddressValidator()
        {
        ...
        //{
        //    return string.Format(CultureInfo.CurrentCulture, message, $"{property} {PropertyNames.ProjectRemoteAddress}");
        //}
    }
}