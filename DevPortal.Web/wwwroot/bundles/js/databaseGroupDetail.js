$("#deleteDatabaseGroup").on("click", () => {
    deleteEnvironment();
});

function deleteEnvironment() {
    const id = $("#databaseGroupId").val();
    Swal.fire({
        title: 'Emin misiniz?',
...
const databaseGroupName = $("#databaseGroupName").val();
$("#favourite").on("click", () => {
    var pageUrl = window.location.href;
    addFavourite(databaseGroupName, pageUrl);
});