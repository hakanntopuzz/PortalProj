$("#deleteExternalDependency").on("click", () => {
    deleteEnvironment();
});

function deleteEnvironment() {
    const id = $("#externalDependencyId").val();
    Swal.fire({
        title: 'Emin misiniz?',
...
const externalDependencyApplicationName = $("#externalDependencyApplicationName").val();
$("#favourite").on("click", () => {
    var pageUrl = window.location.href;
    addFavourite(externalDependencyApplicationName, pageUrl);
});