$("#deleteDatabaseType").on("click", () => {
    deleteEnvironment();
});

function deleteEnvironment() {
    const id = $("#databaseTypeId").val();
    Swal.fire({
        title: 'Emin misiniz?',
...
const databaseTypeName = $("#databaseTypeName").val();
$("#favourite").on("click", () => {
    var pageUrl = window.location.href;
    addFavourite(databaseTypeName, pageUrl);
});